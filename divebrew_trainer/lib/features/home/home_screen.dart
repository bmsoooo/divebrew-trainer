                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    StreamBuilder<PersonalBest?>(
                      stream:
                          (db.select(db.personalBests)..where(
                                (p) => p.type.equals(TableType.static_.name),
                              ))
                              .watchSingleOrNull(),
                    ...
                    // 바다 컨디션 — 훈련 CTA보다 앞세우지 않고, 바다에 갈 때만 참고하는 정보 카드.
                    Text(l10n.homeMarineLabel, style: utilityLabelStyle),
                    const SizedBox(height: 10),
